...
#
# @test_name : int_lldp_notset.paloalto-panos.gawk
...
ENDFILE {
	if ( pass ) print_err("int_lldp_notset.paloalto-panos.gawk","interface <lldp yes> is not set",0,"high","pass");
}
